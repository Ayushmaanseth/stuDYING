...
- [ ] Add an email address to the `ADMINS` settings variable in `stuDYING/stuDYING/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `stuDYING/stuDYING/settings/production.py`
...
- Create a copy of ``stuDYING/settings/local.py.example``:  
  `cp stuDYING/settings/local.py.example stuDYING/settings/local.py` (remembering you should replace `stuDYING` with your project's name!).
